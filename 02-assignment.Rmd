...
```
For this assignment, you'll be working with the `sc_debt.Rata` to predict earnings levels of college graduates using conditional means. You'll need to select the college-level characteristics that you think might be related to earnings levels. Please complete the following steps:
