...
```
For this assignment, you'll be working with the `sc_debt.Ratas` to predict earnings levels of college graduates using conditional means. You'll need to select the college-level characteristics that you think might be related to earnings levels. Please complete the following steps:
...
Submit your assignment as `02-assignment-<yourlastname>.Rmd`, where `<yourlastname>` is your last name. (By the way, any time you see this: `<sometext>`, that indicates that you need to substitute something in, so if I were to submit the above assignment, it would be as: `02-assignment-garcia.Rmd`)
