...
if(file.exists("attend.xls")==FALSE){
  download.file("https://nces.ed.gov/programs/digest/d13/tables/xls/tabn203.90.xls",destfile="attend.xls", mode="wb")
...
# I changed nothing... I restarted R and it worked this time. 
